...
export const Selection = 'selection' as any as ComponentType<{ children: ReactNode }>;
export const Fragment = 'fragment' as any as ComponentType<{ children: ReactNode }>;
export const Text = 'text' as any as ComponentType<{ children?: ReactNode; [mark: string]: any }>;
export const Paragraph = PARAGRAPH_TYPE as any as ComponentType<{ children: ReactNode }>;
export const Link = LINK_TYPE as any as ComponentType<{ href: string; children?: ReactNode }>;
export const Divider = DIVIDER_TYPE as any as ComponentType<{ children?: ReactNode }>;
export const OrderedList = ORDERED_LIST_TYPE as any as ComponentType<{ children: ReactNode }>;
export const UnorderedList = UNORDERED_LIST_TYPE as any as ComponentType<{ children: ReactNode }>;
export const ListItem = LIST_ITEM_TYPE as any as ComponentType<{ children: ReactNode }>;
export const ListItemText = LIST_ITEM_TEXT_TYPE as any as ComponentType<{ children: ReactNode }>;
...
function withVoidElements<T extends Slate.Editor>(editor: T, types: string[] = VOID_ELEMENTS): T {
    const { isVoid } = editor;
