            ...
            >
                <InputGroup>
                    <FormControl
                        ...
                        autoFocus={false}
                        className="editor-v4-floating-story-embed-input__input"
                        inputRef={(ref) => {
                        ...
                        value={url}
                    />
                    <InputGroup.Addon className="editor-v4-floating-story-embed-input__addon">
                        <Button
                            bsStyle="success"
                            className="editor-v4-floating-story-embed-input__button"
